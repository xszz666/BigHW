...
int main(int argc, char** argv)
{
	...
	if (test_choise[T_TRIANGLE] == '1') {
		...
		for (i = 0; i < 20; i++) {
			...
			x3 = rand() % (win_width);
			y3 = rand() % (win_high);
			hdc_triangle(x1, y1, x2, y2, x3, y3, i % 2); //i%2使空心实心交替
			Sleep(500);
		}
	...
	if (test_choise[T_MATHCURVE] == '1') {
		...
		struct {
			...
			{2050249, "徐正扬", hdc_draw_Mathematical_curve_2050249},
			{2050265, "黄昊",  hdc_draw_Mathematical_curve_2050265},
			{2051500, "杜奇蔚", hdc_draw_Mathematical_curve_2051500	},
			{2051565, "龚天遥", hdc_draw_Mathematical_curve_2051565},
			{2051995, "朱泽凯", hdc_draw_Mathematical_curve_2051995},
			{2052432, "孙致远", hdc_draw_Mathematical_curve_2052432},
			{2052479, "孙颖斌", hdc_draw_Mathematical_curve_2052479},
			{2053287, "陈晗舸", hdc_draw_Mathematical_curve_2053287},
			{2053394, "张弛",   hdc_draw_Mathematical_curve_2053394},
			{2053642, "李博宇", hdc_draw_Mathematical_curve_2053642},
			{2054100, "林志桓", hdc_draw_Mathematical_curve_2054100},
			{0,NULL,NULL}
		};
		...
		*/
		...
		hdc_draw_Mathematical_curve_2152611();
	}
	...
	if (test_choise[T_CUSTOM] == '1') {
		...
		struct {
			...
			{2050249, "徐正扬", hdc_draw_cartoon_2050249, 400, 400},
			{2050265, "黄昊",  hdc_draw_cartoon_2050265, 400, 400},
			{2051500, "杜奇蔚", hdc_draw_cartoon_2051500, 400, 400	},
			{2051565, "龚天遥", hdc_draw_cartoon_2051565, 400, 400},
			{2051995, "朱泽凯", hdc_draw_cartoon_2051995, 400, 400},
			{2052432, "孙致远", hdc_draw_cartoon_2052432, 400, 400},
			{2052479, "孙颖斌", hdc_draw_cartoon_2052479, 400, 400},
			{2053287, "陈晗舸", hdc_draw_cartoon_2053287, 400, 400},
			{2053394, "张弛",   hdc_draw_cartoon_2053394, 400, 400},
			{2053642, "李博宇", hdc_draw_cartoon_2053642, 400, 400},
			{2054100, "林志桓", hdc_draw_cartoon_2054100, 0, 0}, //志桓哥哥没遵守要求，拖出去打死，为了他特地结构体加了x/y
			{0,NULL,NULL}
		};
		/* 显示显示助教哥哥/姐姐们画的卡通图像
		   注：调用函数前，先要添加对应的cpp并在.h中加函数声明
		*/
		...
		/* 在此添加自己的卡通图，具体内容可自选，额外加分项
		   注：为了统一，hdc_draw_cartoon_学号 的参照点坐标传入参数定死为（400,400），保证在(400,400)是显示正确，
			  但在函数内部不要定死（400，400）
		*/
		hdc_draw_cartoon_2152611(400, 400);
	}
